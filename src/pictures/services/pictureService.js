...
export const createPicture = () => {
  ...
  const handleSubmitCreatePic = data => {
    try {
      ...
      onReset(INPUTS_ARRAY, ERRORS_ARRAY, CREATE_PIC_SUBMIT_BTN, rest.handleReset, onChangePage);
      pictures.push(pic);
      console.log(pic);
  ...
  CREATE_PIC_CANCEL_BTN.addEventListener("click", () =>
    onReset(INPUTS_ARRAY, ERRORS_ARRAY, CREATE_PIC_SUBMIT_BTN, rest.handleReset, onChangePage(PAGES.HOME))
  );
